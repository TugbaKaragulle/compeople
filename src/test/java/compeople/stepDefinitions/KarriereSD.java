...
public class KarriereSD {
    ...
    @And("klickt auf Unternehmensbereich und wählt {string} aus")
    ...
    @And("klickt auf das Stellenangebot, das das Wort {string} beinhaltet")
